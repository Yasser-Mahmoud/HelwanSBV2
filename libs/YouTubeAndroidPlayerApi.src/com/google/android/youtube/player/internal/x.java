...
public final class x
{
  public static Map<String, String> a(Locale paramLocale)
  {
    ...
    (localHashMap2 = localHashMap1 = new HashMap()).put("error_initializing_player", "An error occurred while initializing the YouTube player.");
    localHashMap2.put("get_youtube_app_title", "Get YouTube App");
    localHashMap2.put("get_youtube_app_text", "This app won't run without the YouTube App, which is missing from your device");
    localHashMap2.put("get_youtube_app_action", "Get YouTube App");
    localHashMap2.put("enable_youtube_app_title", "Enable YouTube App");
    localHashMap2.put("enable_youtube_app_text", "This app won't work unless you enable the YouTube App.");
    localHashMap2.put("enable_youtube_app_action", "Enable YouTube App");
    localHashMap2.put("update_youtube_app_title", "Update YouTube App");
    localHashMap2.put("update_youtube_app_text", "This app won't work unless you update the YouTube App.");
    localHashMap2.put("update_youtube_app_action", "Update YouTube App");
    a(localHashMap1, paramLocale.getLanguage());
    a(localHashMap1, paramLocale.getLanguage() + "_" + paramLocale.getCountry());
